...
export function ActivityHeatmap({ account, crossFilterType }) {
  ...
  if (loading) return <div className="h-[120px] flex items-center justify-center text-xs text-zinc-500 bg-zinc-900/50 border border-zinc-800/50 rounded-xl mt-4">Loading heatmap...</div>;
  ...
  return (
    <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-5 overflow-hidden mt-4">
      ...
      <div className="flex flex-row gap-12 justify-center items-center py-2">
        <div className="flex flex-col gap-1 shrink-0 w-max">
